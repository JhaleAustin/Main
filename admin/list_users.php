...
<div class="box">
    ...
    <div class="box-body">
        <div class="mt-2 mb-3">
            <a href="course.php" class="btn btn-sm btn-flat bg-blue"><i class="fa fa-plus"></i> Add Data</a>
        ...
        <tr>
            ...
            <tbody>
                <?php 
                $sql = "SELECT * FROM user"; // Fetch users instead of courses
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="profile.php?id=<?php echo $row['id']; ?>">See More</a></td>
...
function bulk_delete() {
    ...
    if (confirm('Are you sure you want to delete selected courses?')) {
        $.ajax({
            ...
            data: {course_ids: selectedIds}, // Change courseId to selectedIds
            dataType: 'json',
