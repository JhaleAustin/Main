...
<div class="box">
    ...
    <div class="box-body">
        <div class="mt-2 mb-3">
            <a href="lecture.php" class="btn btn-sm btn-flat bg-blue"><i class="fa fa-plus"></i> Add Data</a>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $row['lecture_email']; ?></td>
...
function bulk_delete() {
    ...
    if (confirm('Are you sure you want to delete selected courses?')) {
        $.ajax({
            ...
            data: {lecture_ids: selectedIds}, // Change courseId to selectedIds
            dataType: 'json',
